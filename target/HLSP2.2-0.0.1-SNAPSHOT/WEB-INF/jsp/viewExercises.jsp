  ...
  <body>
    ...
    <jsp:include page="navigation.jsp"/>
     ...
     <div class ="container pt-3">
			...
			<caption>Aerobic exercises</caption>
			  ...
			  <tbody id="aerobicDisplay">
			  	<c:forEach var="exercise" items="${requestScope.aerobicExercises}">
				      ...
				      <td><a class="btn btn-secondary btn-sm" href="/exercises/edit_aerobic_exercise?id=${exercise.id}" role="button">Edit</a></td>	
			  		</tr>
			  	</c:forEach>
			  </tbody>
			</table>
		...
		<div class="pt-1"> 
			<a class="btn btn-light" href="/exercises/aerobicExerciseForm"> Add aerobic exercise </a>
		</div> 
			  ...
			  <tbody id="strengthDisplay">
			  	<c:forEach var="exercise" items="${requestScope.strengthExercises}">
				    <tr>
				      ...
				      <td><c:out value="${exercise.favourite}"/></td>
					  <td><a class="btn btn-secondary btn-sm" href="/exercises/edit_strength_exercise?id=${exercise.id}" role="button">Edit</a></td>	
				    </tr>
			    </c:forEach>
			  </tbody>
			</table>
		...
		<div class="pt-1">
			<a class="btn btn-light" href="/exercises/strengthExerciseForm"> Add strength training exercise </a> 
		</div>
